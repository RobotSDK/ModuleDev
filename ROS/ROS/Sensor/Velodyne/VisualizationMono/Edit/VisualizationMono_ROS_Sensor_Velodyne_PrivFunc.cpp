...
#include "../NoEdit/VisualizationMono_ROS_Sensor_Velodyne_PrivFunc.h"
...
bool DECOFUNC(setParamsVarsOpenNode)(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
{
	...
	VisualizationMono_ROS_Sensor_Velodyne_Params * params=(VisualizationMono_ROS_Sensor_Velodyne_Params *)paramsPtr;
	VisualizationMono_ROS_Sensor_Velodyne_Vars * vars=(VisualizationMono_ROS_Sensor_Velodyne_Vars *)varsPtr;
...
bool DECOFUNC(processMonoDrainData)(void * paramsPtr, void * varsPtr, QVector<void *> drainParams, QVector<void *> drainData)
{
	VisualizationMono_ROS_Sensor_Velodyne_Params * params=(VisualizationMono_ROS_Sensor_Velodyne_Params *)paramsPtr;
	VisualizationMono_ROS_Sensor_Velodyne_Vars * vars=(VisualizationMono_ROS_Sensor_Velodyne_Vars *)varsPtr;
	QVector<SensorInternalEvent_ROS_Sensor_Velodyne_Params *> drainparams; copyQVector(drainparams,drainParams);
	QVector<SensorInternalEvent_ROS_Sensor_Velodyne_Data *> draindata; copyQVector(draindata,drainData);
