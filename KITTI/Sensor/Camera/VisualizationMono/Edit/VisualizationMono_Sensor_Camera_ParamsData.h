...
/*! \def VisualizationMono_Sensor_Camera_INPUTPORTSSIZE
	...
	\details
	- Input Port #0: Buffer_Size = 10, Params_Type = Simulator_Sensor_Camera_Params, Data_Type = Simulator_Sensor_Camera_Data
*/
#define VisualizationMono_Sensor_Camera_INPUTPORTSSIZE QList<int>()<<10
