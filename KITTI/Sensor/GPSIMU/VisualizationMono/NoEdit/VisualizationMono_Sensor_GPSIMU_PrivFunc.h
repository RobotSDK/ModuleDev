...
#ifndef VISUALIZATIONMONO_SENSOR_GPSIMU_PRIVFUNC_H
#define VISUALIZATIONMONO_SENSOR_GPSIMU_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup VisualizationMono_Sensor_GPSIMU_PrivFunc VisualizationMono_Sensor_GPSIMU_PrivFunc
	\ingroup VisualizationMono_Sensor_GPSIMU
	\brief VisualizationMono_Sensor_GPSIMU_PrivFunc defines the PrivFunc in VisualizationMono_Sensor_GPSIMU.
*/

/*! \addtogroup VisualizationMono_Sensor_GPSIMU_PrivFunc
	@{
*/

/*! \file VisualizationMono_Sensor_GPSIMU_PrivFunc.h
	 Defines the PrivFunc of VisualizationMono_Sensor_GPSIMU
*/

//*******************Please add other headers below*******************


#include "../Edit/VisualizationMono_Sensor_GPSIMU_ParamsData.h"
#include "../Edit/VisualizationMono_Sensor_GPSIMU_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG VisualizationMono_Sensor_GPSIMU

/*! bool VisualizationMono_Sensor_GPSIMU_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool VisualizationMono_Sensor_GPSIMU_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void VisualizationMono_Sensor_GPSIMU_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void VisualizationMono_Sensor_GPSIMU_getMonoDrainDataSize(void * paramsPtr, void * varsPtr, int & drainDataSize)
...
/*! bool VisualizationMono_Sensor_GPSIMU_processMonoDrainData(void * paramsPtr, void * varsPtr, QVector<void *> drainParams, QVector<void *> drainData)
...
/*! void VisualizationMono_Sensor_GPSIMU_visualizationWidgets(void * paramsPtr, void * varsPtr, QList<QWidget *> & widgets)
