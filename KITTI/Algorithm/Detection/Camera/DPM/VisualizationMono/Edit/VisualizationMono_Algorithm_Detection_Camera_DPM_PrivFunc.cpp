...
#include "../NoEdit/VisualizationMono_Algorithm_Detection_Camera_DPM_PrivFunc.h"
...
bool DECOFUNC(setParamsVarsOpenNode)(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
{
	...
	VisualizationMono_Algorithm_Detection_Camera_DPM_Params * params=(VisualizationMono_Algorithm_Detection_Camera_DPM_Params *)paramsPtr;
	VisualizationMono_Algorithm_Detection_Camera_DPM_Vars * vars=(VisualizationMono_Algorithm_Detection_Camera_DPM_Vars *)varsPtr;
...
bool DECOFUNC(processMonoDrainData)(void * paramsPtr, void * varsPtr, QVector<void *> drainParams, QVector<void *> drainData)
{
	VisualizationMono_Algorithm_Detection_Camera_DPM_Params * params=(VisualizationMono_Algorithm_Detection_Camera_DPM_Params *)paramsPtr;
	VisualizationMono_Algorithm_Detection_Camera_DPM_Vars * vars=(VisualizationMono_Algorithm_Detection_Camera_DPM_Vars *)varsPtr;
	QVector<ProcessorMono_Algorithm_Detection_Camera_DPM_Params *> drainparams; copyQVector(drainparams,drainParams);
	QVector<ProcessorMono_Algorithm_Detection_Camera_DPM_Data *> draindata; copyQVector(draindata,drainData);
	...
	*/
	...
	if(image.type()==CV_8UC1)
    {
		...
		for(i=0;i<n;i++)
		{
			...
			//cv::addText(image,QString("%1 : %2").arg(draindata.front()->objects[0].classID).arg(draindata.front()->objects[0].score).toStdString()
			//	,cv::Point(draindata.front()->objects[0].rect.x,draindata.front()->objects[0].rect.y),font);
		}
