...
#ifndef VISUALIZATIONMONO_ALGORITHM_DETECTION_CAMERA_DPM_PRIVFUNC_H
#define VISUALIZATIONMONO_ALGORITHM_DETECTION_CAMERA_DPM_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup VisualizationMono_Algorithm_Detection_Camera_DPM_PrivFunc VisualizationMono_Algorithm_Detection_Camera_DPM_PrivFunc
	\ingroup VisualizationMono_Algorithm_Detection_Camera_DPM
	\brief VisualizationMono_Algorithm_Detection_Camera_DPM_PrivFunc defines the PrivFunc in VisualizationMono_Algorithm_Detection_Camera_DPM.
*/

/*! \addtogroup VisualizationMono_Algorithm_Detection_Camera_DPM_PrivFunc
	@{
*/

/*! \file VisualizationMono_Algorithm_Detection_Camera_DPM_PrivFunc.h
	 Defines the PrivFunc of VisualizationMono_Algorithm_Detection_Camera_DPM
*/

//*******************Please add other headers below*******************


#include "../Edit/VisualizationMono_Algorithm_Detection_Camera_DPM_ParamsData.h"
#include "../Edit/VisualizationMono_Algorithm_Detection_Camera_DPM_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG VisualizationMono_Algorithm_Detection_Camera_DPM

/*! bool VisualizationMono_Algorithm_Detection_Camera_DPM_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool VisualizationMono_Algorithm_Detection_Camera_DPM_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void VisualizationMono_Algorithm_Detection_Camera_DPM_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void VisualizationMono_Algorithm_Detection_Camera_DPM_getMonoDrainDataSize(void * paramsPtr, void * varsPtr, int & drainDataSize)
...
/*! bool VisualizationMono_Algorithm_Detection_Camera_DPM_processMonoDrainData(void * paramsPtr, void * varsPtr, QVector<void *> drainParams, QVector<void *> drainData)
...
/*! void VisualizationMono_Algorithm_Detection_Camera_DPM_visualizationWidgets(void * paramsPtr, void * varsPtr, QList<QWidget *> & widgets)
