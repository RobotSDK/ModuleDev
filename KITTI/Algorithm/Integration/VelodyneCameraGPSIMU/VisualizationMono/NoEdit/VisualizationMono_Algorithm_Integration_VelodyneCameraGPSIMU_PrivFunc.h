...
#ifndef VISUALIZATIONMONO_ALGORITHM_INTEGRATION_VELODYNECAMERAGPSIMU_PRIVFUNC_H
#define VISUALIZATIONMONO_ALGORITHM_INTEGRATION_VELODYNECAMERAGPSIMU_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_PrivFunc VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_PrivFunc
	\ingroup VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU
	\brief VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_PrivFunc defines the PrivFunc in VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU.
*/

/*! \addtogroup VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_PrivFunc
	@{
*/

/*! \file VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_PrivFunc.h
	 Defines the PrivFunc of VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU
*/

//*******************Please add other headers below*******************


#include "../Edit/VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_ParamsData.h"
#include "../Edit/VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU

/*! bool VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_getMonoDrainDataSize(void * paramsPtr, void * varsPtr, int & drainDataSize)
...
/*! bool VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_processMonoDrainData(void * paramsPtr, void * varsPtr, QVector<void *> drainParams, QVector<void *> drainData)
...
/*! void VisualizationMono_Algorithm_Integration_VelodyneCameraGPSIMU_visualizationWidgets(void * paramsPtr, void * varsPtr, QList<QWidget *> & widgets)
