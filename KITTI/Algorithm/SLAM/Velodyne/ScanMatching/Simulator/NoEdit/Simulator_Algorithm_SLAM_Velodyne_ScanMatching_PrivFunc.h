...
#ifndef SIMULATOR_ALGORITHM_SLAM_VELODYNE_SCANMATCHING_PRIVFUNC_H
#define SIMULATOR_ALGORITHM_SLAM_VELODYNE_SCANMATCHING_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup Simulator_Algorithm_SLAM_Velodyne_ScanMatching_PrivFunc Simulator_Algorithm_SLAM_Velodyne_ScanMatching_PrivFunc
	\ingroup Simulator_Algorithm_SLAM_Velodyne_ScanMatching
	\brief Simulator_Algorithm_SLAM_Velodyne_ScanMatching_PrivFunc defines the PrivFunc in Simulator_Algorithm_SLAM_Velodyne_ScanMatching.
*/

/*! \addtogroup Simulator_Algorithm_SLAM_Velodyne_ScanMatching_PrivFunc
	@{
*/

/*! \file Simulator_Algorithm_SLAM_Velodyne_ScanMatching_PrivFunc.h
	 Defines the PrivFunc of Simulator_Algorithm_SLAM_Velodyne_ScanMatching
*/

//*******************Please add other headers below*******************


#include "../Edit/Simulator_Algorithm_SLAM_Velodyne_ScanMatching_ParamsData.h"
#include "../Edit/Simulator_Algorithm_SLAM_Velodyne_ScanMatching_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG Simulator_Algorithm_SLAM_Velodyne_ScanMatching

/*! bool Simulator_Algorithm_SLAM_Velodyne_ScanMatching_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool Simulator_Algorithm_SLAM_Velodyne_ScanMatching_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void Simulator_Algorithm_SLAM_Velodyne_ScanMatching_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void Simulator_Algorithm_SLAM_Velodyne_ScanMatching_initializeOutputData(void * paramsPtr, void * varsPtr, boost::shared_ptr<void> & outputDataPtr)
...
/*! bool Simulator_Algorithm_SLAM_Velodyne_ScanMatching_generateSourceData(void * paramsPtr, void * varsPtr, void * outputData, QList<int> & outputPortIndex, QTime & timeStamp)
