...
#include "../NoEdit/ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_PrivFunc.h"
...
bool DECOFUNC(setParamsVarsOpenNode)(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
{
	...
	ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Params * params=(ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Params *)paramsPtr;
	ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Vars * vars=(ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Vars *)varsPtr;
...
void DECOFUNC(initializeOutputData)(void * paramsPtr, void * varsPtr, boost::shared_ptr<void> & outputDataPtr)
{
	ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Params * params=(ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Params *)paramsPtr;
	ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Vars * vars=(ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Vars *)varsPtr;
	outputDataPtr=boost::shared_ptr<void>(new ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Data());
...
bool DECOFUNC(processMultiInputData)(void * paramsPtr, void * varsPtr, QVector<QVector<void *> > inputParams, QVector<QVector<void *> > inputData, void * outputData, QList<int> & outputPortIndex)
{
	ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Params * params=(ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Params *)paramsPtr;
	ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Vars * vars=(ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Vars *)varsPtr;
	QVector<ProcessorMulti_Algorithm_Integration_VirtualScanCamera_Params *> inputparams_0; copyQVector(inputparams_0,inputParams[0]);
	QVector<SensorInternalEvent_Algorithm_Detection_DPM_Params *> inputparams_1; copyQVector(inputparams_1,inputParams[1]);
	QVector<ProcessorMulti_Algorithm_Integration_VirtualScanCamera_Data *> inputdata_0; copyQVector(inputdata_0,inputData[0]);
	QVector<SensorInternalEvent_Algorithm_Detection_DPM_Data *> inputdata_1; copyQVector(inputdata_1,inputData[1]);
	ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Data * outputdata=(ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Data *)outputData;
