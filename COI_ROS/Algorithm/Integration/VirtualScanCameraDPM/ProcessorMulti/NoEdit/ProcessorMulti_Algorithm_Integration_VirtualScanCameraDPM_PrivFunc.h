...
#ifndef PROCESSORMULTI_ALGORITHM_INTEGRATION_VIRTUALSCANCAMERADPM_PRIVFUNC_H
#define PROCESSORMULTI_ALGORITHM_INTEGRATION_VIRTUALSCANCAMERADPM_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_PrivFunc ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_PrivFunc
	\ingroup ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM
	\brief ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_PrivFunc defines the PrivFunc in ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM.
*/

/*! \addtogroup ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_PrivFunc
	@{
*/

/*! \file ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_PrivFunc.h
	 Defines the PrivFunc of ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM
*/

//*******************Please add other headers below*******************


#include "../Edit/ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_ParamsData.h"
#include "../Edit/ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM

/*! bool ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_initializeOutputData(void * paramsPtr, void * varsPtr, boost::shared_ptr<void> & outputDataPtr)
...
/*! void ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_getMultiInputDataSize(void * paramsPtr, void * varsPtr, QList<int> & inputDataSize)
...
/*! bool ProcessorMulti_Algorithm_Integration_VirtualScanCameraDPM_processMultiInputData(void * paramsPtr, void * varsPtr, QVector<QVector<void *> > inputParams, QVector<QVector<void *> > inputData, void * outputData, QList<int> & outputPortIndex)
