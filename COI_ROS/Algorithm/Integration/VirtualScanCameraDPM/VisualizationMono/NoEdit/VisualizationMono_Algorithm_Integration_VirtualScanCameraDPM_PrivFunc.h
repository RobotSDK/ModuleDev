...
#ifndef VISUALIZATIONMONO_ALGORITHM_INTEGRATION_VIRTUALSCANCAMERADPM_PRIVFUNC_H
#define VISUALIZATIONMONO_ALGORITHM_INTEGRATION_VIRTUALSCANCAMERADPM_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_PrivFunc VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_PrivFunc
	\ingroup VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM
	\brief VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_PrivFunc defines the PrivFunc in VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM.
*/

/*! \addtogroup VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_PrivFunc
	@{
*/

/*! \file VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_PrivFunc.h
	 Defines the PrivFunc of VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM
*/

//*******************Please add other headers below*******************


#include "../Edit/VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_ParamsData.h"
#include "../Edit/VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM

/*! bool VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_getMonoDrainDataSize(void * paramsPtr, void * varsPtr, int & drainDataSize)
...
/*! bool VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_processMonoDrainData(void * paramsPtr, void * varsPtr, QVector<void *> drainParams, QVector<void *> drainData)
...
/*! void VisualizationMono_Algorithm_Integration_VirtualScanCameraDPM_visualizationWidgets(void * paramsPtr, void * varsPtr, QList<QWidget *> & widgets)
