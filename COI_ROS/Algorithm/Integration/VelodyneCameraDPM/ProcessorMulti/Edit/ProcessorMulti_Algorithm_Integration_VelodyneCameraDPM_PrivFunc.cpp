...
#include "../NoEdit/ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_PrivFunc.h"
...
bool DECOFUNC(setParamsVarsOpenNode)(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
{
	...
	ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_Params * params=(ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_Params *)paramsPtr;
	ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_Vars * vars=(ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_Vars *)varsPtr;
...
void DECOFUNC(initializeOutputData)(void * paramsPtr, void * varsPtr, boost::shared_ptr<void> & outputDataPtr)
{
	ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_Params * params=(ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_Params *)paramsPtr;
	ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_Vars * vars=(ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_Vars *)varsPtr;
	outputDataPtr=boost::shared_ptr<void>(new ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_Data());
...
bool DECOFUNC(processMultiInputData)(void * paramsPtr, void * varsPtr, QVector<QVector<void *> > inputParams, QVector<QVector<void *> > inputData, void * outputData, QList<int> & outputPortIndex)
{
	...
	ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_Data * outputdata=(ProcessorMulti_Algorithm_Integration_VelodyneCameraDPM_Data *)outputData;
