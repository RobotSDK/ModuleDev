...
#ifndef PROCESSORMULTI_ALGORITHM_INTEGRATION_SEGMENTATIONCAMERADPM_PRIVFUNC_H
#define PROCESSORMULTI_ALGORITHM_INTEGRATION_SEGMENTATIONCAMERADPM_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_PrivFunc ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_PrivFunc
	\ingroup ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM
	\brief ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_PrivFunc defines the PrivFunc in ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM.
*/

/*! \addtogroup ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_PrivFunc
	@{
*/

/*! \file ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_PrivFunc.h
	 Defines the PrivFunc of ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM
*/

//*******************Please add other headers below*******************


#include "../Edit/ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_ParamsData.h"
#include "../Edit/ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM

/*! bool ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_initializeOutputData(void * paramsPtr, void * varsPtr, boost::shared_ptr<void> & outputDataPtr)
...
/*! void ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_getMultiInputDataSize(void * paramsPtr, void * varsPtr, QList<int> & inputDataSize)
...
/*! bool ProcessorMulti_Algorithm_Integration_SegmentationCameraDPM_processMultiInputData(void * paramsPtr, void * varsPtr, QVector<QVector<void *> > inputParams, QVector<QVector<void *> > inputData, void * outputData, QList<int> & outputPortIndex)
