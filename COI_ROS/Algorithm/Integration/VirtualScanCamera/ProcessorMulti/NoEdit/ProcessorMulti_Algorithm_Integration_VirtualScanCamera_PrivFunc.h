...
#ifndef PROCESSORMULTI_ALGORITHM_INTEGRATION_VIRTUALSCANCAMERA_PRIVFUNC_H
#define PROCESSORMULTI_ALGORITHM_INTEGRATION_VIRTUALSCANCAMERA_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup ProcessorMulti_Algorithm_Integration_VirtualScanCamera_PrivFunc ProcessorMulti_Algorithm_Integration_VirtualScanCamera_PrivFunc
	\ingroup ProcessorMulti_Algorithm_Integration_VirtualScanCamera
	\brief ProcessorMulti_Algorithm_Integration_VirtualScanCamera_PrivFunc defines the PrivFunc in ProcessorMulti_Algorithm_Integration_VirtualScanCamera.
*/

/*! \addtogroup ProcessorMulti_Algorithm_Integration_VirtualScanCamera_PrivFunc
	@{
*/

/*! \file ProcessorMulti_Algorithm_Integration_VirtualScanCamera_PrivFunc.h
	 Defines the PrivFunc of ProcessorMulti_Algorithm_Integration_VirtualScanCamera
*/

//*******************Please add other headers below*******************


#include "../Edit/ProcessorMulti_Algorithm_Integration_VirtualScanCamera_ParamsData.h"
#include "../Edit/ProcessorMulti_Algorithm_Integration_VirtualScanCamera_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG ProcessorMulti_Algorithm_Integration_VirtualScanCamera

/*! bool ProcessorMulti_Algorithm_Integration_VirtualScanCamera_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool ProcessorMulti_Algorithm_Integration_VirtualScanCamera_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void ProcessorMulti_Algorithm_Integration_VirtualScanCamera_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void ProcessorMulti_Algorithm_Integration_VirtualScanCamera_initializeOutputData(void * paramsPtr, void * varsPtr, boost::shared_ptr<void> & outputDataPtr)
...
/*! void ProcessorMulti_Algorithm_Integration_VirtualScanCamera_getMultiInputDataSize(void * paramsPtr, void * varsPtr, QList<int> & inputDataSize)
...
/*! bool ProcessorMulti_Algorithm_Integration_VirtualScanCamera_processMultiInputData(void * paramsPtr, void * varsPtr, QVector<QVector<void *> > inputParams, QVector<QVector<void *> > inputData, void * outputData, QList<int> & outputPortIndex)
