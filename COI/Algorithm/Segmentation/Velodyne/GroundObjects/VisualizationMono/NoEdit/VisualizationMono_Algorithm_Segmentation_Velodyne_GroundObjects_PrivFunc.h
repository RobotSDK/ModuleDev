...
#ifndef VISUALIZATIONMONO_ALGORITHM_SEGMENTATION_VELODYNE_GROUNDOBJECTS_PRIVFUNC_H
#define VISUALIZATIONMONO_ALGORITHM_SEGMENTATION_VELODYNE_GROUNDOBJECTS_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_PrivFunc VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_PrivFunc
	\ingroup VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects
	\brief VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_PrivFunc defines the PrivFunc in VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects.
*/

/*! \addtogroup VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_PrivFunc
	@{
*/

/*! \file VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_PrivFunc.h
	 Defines the PrivFunc of VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects
*/

//*******************Please add other headers below*******************


#include "../Edit/VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_ParamsData.h"
#include "../Edit/VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects

/*! bool VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_getMonoDrainDataSize(void * paramsPtr, void * varsPtr, int & drainDataSize)
...
/*! bool VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_processMonoDrainData(void * paramsPtr, void * varsPtr, QVector<void *> drainParams, QVector<void *> drainData)
...
/*! void VisualizationMono_Algorithm_Segmentation_Velodyne_GroundObjects_visualizationWidgets(void * paramsPtr, void * varsPtr, QList<QWidget *> & widgets)
