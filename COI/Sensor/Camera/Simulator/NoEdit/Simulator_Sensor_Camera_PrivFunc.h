...
#ifndef SIMULATOR_SENSOR_CAMERA_PRIVFUNC_H
#define SIMULATOR_SENSOR_CAMERA_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup Simulator_Sensor_Camera_PrivFunc Simulator_Sensor_Camera_PrivFunc
	\ingroup Simulator_Sensor_Camera
	\brief Simulator_Sensor_Camera_PrivFunc defines the PrivFunc in Simulator_Sensor_Camera.
*/

/*! \addtogroup Simulator_Sensor_Camera_PrivFunc
	@{
*/

/*! \file Simulator_Sensor_Camera_PrivFunc.h
	 Defines the PrivFunc of Simulator_Sensor_Camera
*/

//*******************Please add other headers below*******************


#include "../Edit/Simulator_Sensor_Camera_ParamsData.h"
#include "../Edit/Simulator_Sensor_Camera_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG Simulator_Sensor_Camera

/*! bool Simulator_Sensor_Camera_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool Simulator_Sensor_Camera_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void Simulator_Sensor_Camera_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void Simulator_Sensor_Camera_initializeOutputData(void * paramsPtr, void * varsPtr, boost::shared_ptr<void> & outputDataPtr)
...
/*! bool Simulator_Sensor_Camera_generateSourceData(void * paramsPtr, void * varsPtr, void * outputData, QList<int> & outputPortIndex, QTime & timeStamp)
